...
@section('content')
    <div class="container">
        <div class="tbl-container" style="margin-left:20% !important;">
            <table>
                <tbody><tr>
                    <th class="headings" align="left">&nbsp;Update Profile</th>
                </tr>
                </tbody></table>
            <div class="c-pass">
                    ...
                    <tbody><tr>
                        <td class="subheadings">
                            <table>
                                <tbody><tr>
                                    <td>First Name :</td>
                                    <td>
                                        <span id="siteDataHolder_lblFName">{{ auth()->user()->first_name }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Last Name :</td>
                                    <td>
                                        <span id="siteDataHolder_lblLName">{{ auth()->user()->last_name }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Date Of Birth :</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="state" id="state" style="width:155px;">
                                            ...
                                            <option value="DADAR AND NAGAR HAVE">DADAR AND NAGAR HAVE</option>
                                            ...
                                            <option selected="selected" value="MAHARAHSTRA">MAHARAHSTRA</option>
                                ...
                                <tr>
                                    <td>City :</td>
                                    <td>
                                        <select name="ctl00$siteDataHolder$drpCity" id="siteDataHolder_drpCity" style="width:155px;">
                                            <option value="A">A</option>
                                            ...
                                            <option value="PURIGALLI MALAVALLI TQ">PURIGALLI MALAVALLI TQ</option>
                                ...
                                <tr>
                                    <td>Pin Code :</td>
                                    <td>
                                        <span id="siteDataHolder_lblPin">{{ auth()->user()->pin_code }}</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Address :</td>
                                    <td>
                                        <textarea name="ctl00$siteDataHolder$txtAddress" rows="2" cols="23" id="siteDataHolder_txtAddress">Mumbai</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Phone :</td>
                                ...
                                <tr>
                                    <td>Email-Id :</td>
                                    <td>
                                        <input name="email" type="text" readonly="readonly" id="siteDataHolder_txtEmail" style="width:150px;" value="{{ auth()->user()->email }}">
                                    </td>
                                </tr>
                                <tr>
                                    <td>Occupation :</td>
                                    <td>
                                        <select name="occupation" id="siteDataHolder_drpOccupation" style="width:155px;">
                                            <option value="ACCOUNTING">ACCOUNTING</option>
                                            <option value="BHIMA">BHIMA</option>
                                            <option selected="selected" value="BISUNESS">BISUNESS</option>
                                            ...
                                            <option value="RAMESH_PANDYA@YAH.">RAMESH_PANDYA@YAH.</option>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <table>
                                            <tbody><tr>
                                                <td>
                                                    <input type="submit" name="ctl00$siteDataHolder$btnSubmit" value="Update" id="siteDataHolder_btnSubmit">
                                                </td>
                                                <td>
                                                    <input type="button" name="ctl00$siteDataHolder$btnReset" value="Reset" onclick="javascript:__doPostBack('ctl00$siteDataHolder$btnReset','')" id="siteDataHolder_btnReset">
                                                </td>
                                            </tr>
                                            </tbody></table>
                                    </td>
                        ...
                        <td valign="top" align="right">
                            <table style="width:100%; display:none">
                                <tbody><tr>
                                    <td>
                                        <iframe id="iframeUploadImage" frameborder="0" scrolling="no" height="100px" width="90px" style="margin-top: -7px; display: block;" src="UploadImage.aspx"></iframe>
                                    </td>
                                    <td>
                                        <img src="../content/images/loading.gif" height="15px" alt="Loading...." id="loadingImage" style="display:none;">
                                    </td>
                                    <td align="right">
                                        <div class="imgHover">
                                            <div class="hover">
                                                <a id="lnkChangeImage" href="javascript://">Change Image</a>
                                            </div>
                                            <img id="siteDataHolder_imgProfilePic" src="" style="height:150px;width:150px;">
                                        </div>
                                    </td>
                                </tr>
                                </tbody></table>
